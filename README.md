# Personal Notes Q&A - Beginner Simple RAG

## Project Overview

Personal Notes Q&A - Beginner Simple RAG is a complete full-stack AI project for **Simple RAG** at **Beginner** difficulty. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.
...
```text
ai-simple-rag-personal-notes-q-a/
  backend/
    app/
      main.py
      config.py
